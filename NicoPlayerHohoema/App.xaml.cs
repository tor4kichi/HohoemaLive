...
namespace HohoemaLive
{
    ...
    sealed partial class App : PrismApplication
    {
        ...
        public override void RegisterTypes(IContainerRegistry container)
        {
            ...
            MonkeyCache.LiteDB.Barrel.ApplicationId = nameof(HohoemaLive);
...
#region Page and Application Appiarance
        ...
        public override void ConfigureViewModelLocator()
        {
            ViewModelLocationProvider.SetDefaultViewTypeToViewModelTypeResolver(viewType => 
            {
                ...
                var pageNameWithParameter = assemblyQualifiedAppType.Replace(viewType.FullName, "HohoemaLive.ViewModels.{0}ViewModel");
