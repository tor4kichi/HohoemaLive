...
namespace HohoemaLive.Views.Controls
{
    /// <summary>
        ...
        private void UpdateScrollHeaderBehavior()
        {
            ...
            switch (Mode)
            {
                ...
                case ScrollHeaderMode.QuickReturn:
                    Microsoft.Xaml.Interactivity.Interaction.GetBehaviors(targetListViewBase).Add(new HohoemaLive.Views.Controls.QuickReturnHeaderBehavior());
                    break;
                case ScrollHeaderMode.Sticky:
                    Microsoft.Xaml.Interactivity.Interaction.GetBehaviors(targetListViewBase).Add(new HohoemaLive.Views.Controls.StickyHeaderBehavior());
                    break;
